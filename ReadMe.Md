...
## Farming 1.01 update:
Fix:
- tools req steel for repair
- food not displaying values
- well
...
Known bug:
- Frying pan right click enabled during pve. Dmg removed, stamina cost higher. Mechanic remaining for comedic value
